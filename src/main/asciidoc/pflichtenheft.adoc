...
|Essentielle Schritte        a|User klickt auf den Knopf “show Results”.
|Erweiterungen                |-
...
|Voraussetzungen             a|ist als User eingeloggt
|Essentielle Schritte        a|User klickt auf  den Knopf “message”.
|Erweiterungen                |-
...
|ID                         |**<<>>**
|Name                       |join
|Beschreibung               |User kann einer Gemeinschaft beitreten.
|Actors                     |User
|Trigger                    |User Benutzer möchte eine Gemeinschaft beitreten.
|Precondition(s)           a|1）User hat sich beim System authentifiziert
|                           |2）User hat ein Passwort einer Gemeinschaft.
|Essential Steps           a|1）User drückt auf der Website auf den Knopf "Community beitreten".
|                           |2）Geben User das Passwort ein
|Extensions                 |-
...
|Actors                     |User
|Trigger                    |User möchte aus einer Gemeinschaft aussteigen
|Precondition(s)           a|1）User hat sich beim System authentifiziert
|                           |2）User ist ein Mitglied der Gemeinschaft
|Essential Steps           a|User drückt auf der Website die Schaltfläche "Community löschen".
|Extensions                 |-
|Functional Requirements    |brauch noch
|===
...
|ID                         |**<<>>**
|Name                       |create
|Beschreibung               |User kann eine Gemeinschaft erstellen, das Passwort der Gemeinschaft
|                           |erhalten und das Passwort verwenden, um andere in die Gemeinschaft einzuladen.
|Actors                     |User
|Trigger                    |User möchte eine Gemeinschaft erstellen.
|Precondition(s)           a|User hat sich beim System authentifiziert.
|Essential Steps           a|User klickt auf der Webseite auf den Knopf "Eine Gemeinschaft erstellen".
|Extensions                 |User kann andere Mitglieder in der Gemeinschaft einladen.
...
|ID                         |**<<>>**
|Name                       |kick
|Beschreibung               |Nach zehn erfolglosen Abbuchungsbenachrichtigungen wird der Nutzer
|                           |vorübergehend aus der Community entfernt.
|Actors                     |Gemeischaft
|Trigger                    |Ein Nutzer in einer Gemeinschaft hat eine erfolglose
|                           |Abbuchungsbenachrichtigungen erhalten.
|Precondition(s)           a|1）Actor is in der Gemeinschaft.
|                           |2）Actor hat neu mal erfolglose Abbuchungsbenachrichtigungen erhalten.
|Essential Steps           a|--
|Extensions                 |--
|Functional Requirements    |F0018
|===
...
|Actors                     |Admin
|Trigger                    |Klicken Administratoren auf "Wettstatus"
|Precondition(s)           a|Benutzer hat Lotto gekauft
|Essential Steps           a|1. Der Administrator klickt auf ""Lottoergebnisse anzeigen""
...
|Actors                     |Admin
|Trigger                    |Klicken Administratoren auf "finanzielle Situation"
|Precondition(s)           a|1.Benutzer hat Lotto gekauft
2.Die Lotterie wurde gezogen oder das Ergebnis des Spiels wurde veröffentlicht
|Essential Steps           a|1. Der Manager klickt auf "finanzielle Situation"
...
|Actors                     |Admin
|Trigger                    |Klicken Administratoren auf "Ergebnisse zeichnen"
|Precondition(s)           a|1. Lotto wurde gezogen
2. Benutzer kauft Lotto
|Essential Steps           a|1. Der Administrator sendet einen Abzugsantrag an die Konten aller Benutzer, die die Lotterie gekauft haben
...
|===
|ID                         |**<<>>**
|Name                       |Aus der Community entfernen
|Beschreibung               |Benutzer, die in der Community Fußball-Lotterietickets gekauft und das Geld nicht zehnmal abgezogen haben, werden aus der Community entfernt
|Actors                     |Admin
|Trigger                    |Klicken Administratoren auf "Ergebnisse zeichnen"
|Precondition(s)           a|Abzug fehlgeschlagen
|Essential Steps           a|1. Senden Sie einen Antrag auf Abzug von zwei Euro und senden Sie eine Nachricht an das Konto des Benutzers, der das Fußball-Lotterieticket nicht abgezogen hat
2. Stellen Sie fest, ob der Benutzer den zehnten Abzug nicht bestanden hat
3. Wenn ja, löschen Sie den Benutzer aus der Community-Liste
|Extensions                 |-
|Functional Requirements    |-
|===
...
|Actors                     |Admin
|Trigger                    |Klicken Administratoren auf "Ergebnisse zeichnen"
|Precondition(s)           a|1. Lotterieergebnisse bekannt gegeben
2. Benutzerkonto wurde erfolgreich belastet
|Essential Steps           a|1. Lesen Sie die finanzielle Situation des Benutzerkontos (gewinnen oder verlieren)
...
|Actors                     |Admin
|Trigger                    |Klicken Administratoren auf "Ergebnis Abrechnung"
|Precondition(s)           a|1. Lotterieergebnisse bekannt gegeben
2. Der Nutzer ist der Gewinner
|Essential Steps           a|1. Der Manager klickt auf "Geld vergeben"
