...
|2.1     | abgeschlossen   | 30.10.2021          | Hannes       | Klassendiagramm
|2.2     | abgeschlossen   | 30.10.2021          | Meng       | Enumeration des Klassendiagramm
...
image::./diagrams/top-level-architecture.svg[top-level-architecture, title= "Top-Level-Architektur", align=center]
...
[[use_case_diagram]]
image::./diagrams/use-case-diagram2.svg[use-case-diagram, title= "Anwendungsfalldiagramm", align=center]
...
2. Benutzer kehrt zurück zur Loginseite und wird Visitor.

|Erweiterungen              |-
|Funktionale Voraussetzungen|[F0003]
|===

image::../diagrams/seq_register_login_logout.svg[seq_register/login/logout, title= "Sequenzdiagramm : register/login/logout ", align=center]
...
image::../diagrams/seq_bet.svg[seq-bet, title= "Sequenzdiagramm : bet", align=center]
...
image:./diagrams/seq_deposit-withdraw.svg[seq_deposit/withdraw, title= "Sequenzdiagramm : deposit/withdral", align=center]
...
image::./diagrams/seq_create.svg[seq_create, title= "Sequenzdiagramm : create", align=center]
...
image::./diagrams/seq_join.svg[seq_join, title= "Sequenzdiagramm : join", align=center]
...
|Voraussetzungen           a|
1. Benutzer besitzt Lottotippschein
|Essenzielle Schritte      a|
...
image::./diagrams/seq_evaluation.svg[seq_evaluation, title= "Sequenzdiagramm : evaluation", align=center]
...
image::./diagrams/seq_money.svg[seq_geld-vergeben, title= "Sequenzdiagramm : Geld vergeben", align=center]
...
image:diagrams/class-diagram.jpg[class-diagram]
...
|BetCatalog         |Eine Seite, auf der ein Benutzer auswählen kann, an welcher Lotterie er teilnehmen möchte, um eine Wette zu platzieren.
...
image::../diagrams/seq_register_login_logout.svg[seq_register/login/logout, title= "register/login/logout", align=center]
...
image::../diagrams/seq_bet.svg[seq-bet, title= "bet", align=center]
...
image::../diagrams/seq_deposit-withdraw.svg[seq_deposit/withdraw, title= "deposit/withdraw", align=center]
...
image::../diagrams/seq_create.svg[seq_create, title= "create", align=center]
...
image::./diagrams/seq_join.svg[seq_join, title= "join", align=center]
