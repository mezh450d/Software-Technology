...
|Actors                     |User
|Trigger                    |User möchte in einer Gemeinschaft beitreten.
|Precondition(s)           a|
...
|Actors                     |User
|Trigger                    |User möchte aus einer Gemeinschaft austreten.
|Precondition(s)           a|
1. User hat sich beim System authentifiziert
2. User ist ein Mitglied der Gemeinschaft
|Essential Steps           a|User drückt auf der Website die Schaltfläche "Gemeischaft löschen".
|Extensions                 |-
...
|Actors                     |Gemeischaft
|Trigger                    |Ein Nutzer in einer Gemeinschaft hat eine erfolglose Abbuchungsbenachrichtigungen erhalten.
|Precondition(s)           a|
1. Actor is in der Gemeinschaft.
2. Actor hat schon neu mal erfolglose Abbuchungsbenachrichtigungen erhalten.
|Essential Steps           a|--
|Extensions                 |--
...
|Essential Steps           a|
1. Senden Sie einen Antrag auf Abzug von zwei Euro und senden Sie eine Nachricht an das Konto des Benutzers, der das Fußball-Lotterieticket nicht abgezogen hat
