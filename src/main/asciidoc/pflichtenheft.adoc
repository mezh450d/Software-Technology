...
image::./diagrams/uml-class-diagram.jpg[uml-class-diagram, title= "UML-Analyse-Klassendiagramm", align=center]
...
image::./diagrams/seq_bet.svg[seq_bet, title= "bet", align=center]
