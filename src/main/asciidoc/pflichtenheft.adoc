...
|2.1     | offen   | 30.10.2021          | Hannes       | Klassendiagramm
|2.2     | offen   | 30.10.2021          | Meng       | Enumeration des Klassendiagramm
...
image:diagrams/use-case-diagram2.svg[use-case-diagram]
...
1.Richtige Daten: Visitor werden User und bekommen zusätzlichen Rechte.
2.Fehler: Anzeige der Fehlermitteilung.

_Logout_:

1. User klickt auf den "ausloggen".
2. Benutzer kehren zur Startseite zurück und werden Visitor.

|Erweiterungen              |-
|Funktionale Voraussetzungen|[F0003]
|===

image:diagrams/seq_register_login_logout.svg[seq_register/login/logout]
[cols="1h, 3"]
[[UC0030]]
|===
|ID                         |**<<UC0030>>**
...
image:diagrams/seq_bet.svg[seq-bet]
...
image:diagrams/seq_deposit-withdraw.svg[seq_deposit/withdraw]
...
image:diagrams/seq_create.svg[seq_create]
...
image:diagrams/seq_join.svg[seq_join]
...
image:diagrams/seq_evaluation.svg[seq_evaluation]
...
image:diagrams/seq_money.svg[seq_geld-vergeben]
...
Die Unterstüzung einer solchen Adresse ermöglicht dem System ebenfalls eine 2-Faktor-Authentifizierung, welche der Kontosicherheit betragen kann.
...
=== /login
image:diagrams/gui/login.jpg[login]

- Startseite, bringt Besucher direkt zum Einloggen
- Registrierungsmöglichkeit

=== /register
image:diagrams/gui/register.jpg[register]

- Formular für Userdaten
- durch Registrieren-Button werden Daten überprüfut und ggf. Nutzer erstellt

=== /overview
image:diagrams/gui/overview.jpg[overview]
...
=== /betting
image:diagrams/gui/betting.jpg[betting]

- zeigt Auswahl vom Wettangebot (erweiterbar)

=== /6-from-49
image:diagrams/gui/6-from-49.jpg[6-from-49]
...
=== /football
image:diagrams/gui/football.jpg[football]
...
=== /community
image:diagrams/gui/community.jpg[community]

- Auflistung aller genutzten Communities des Nutzerkontos
- Möglichkeit, Community einzusehen, zu erstellen oder zu betreten

=== /community/create
image:diagrams/gui/community_create.jpg[community/create]

- Formular zum Erstellen einer Community

=== /community/join
image:diagrams/gui/community_join.jpg[community/join]

- Formular zum Beitreten einer Community

=== /community/overview
image:diagrams/gui/community_overview.jpg[community/overview]
...
=== /community/betting
image:diagrams/gui/community_betting.jpg[community/betting]

- Community Wetten nutzen die gleiche Maske wie Einzelnutzerwetten
- analog für Lotto und Fußballtoto

=== /finance
image:diagrams/gui/finance.jpg[finance]
...
|CommunityManagement  |Benutzer können selbst Communitys erstellen. Andere Benutzer können ebenfalls beitreten. Der Community-Verantwortliche kann Nutzer, die den Anforderungen der Community nicht entsprechen, rauswerfen und hat das Recht, die Community aufzulösen.
|Admin              |Der Verantwortliche der Lotteriezentrale kann Benutzer und Lottoauswertungen verwalten.
...
|Message            |Vom System gesendete Informationen, die vom Benutzer empfangen wurden.
|LotteryCatalog     |Ein Katalog mit digitalen Lottoscheinen, Benutzer können ihre Lieblingszahlen wählen, um Wetten zu platzieren.
|FootballPoolsCatalog  |Ein Verzeichnis von Fußballlotterien, mit dem Benutzer Ergebnisvorhersagen für ihre Lieblingsmannschaften machen können.
...
|Bet                |Benutzer können Wetten auf verschiedene Arten von Lottoscheinen platzieren.
|===
...
|Voraussetzungen       a|Ein Benutzer ist nicht angemeldet und möchte einen Account erstellen.
|Event                 a|Ein nicht authentifizierter Benutzer ruft den Anmeldebildschirm auf, gibt die Anmeldedaten eines bestehenden Benutzers des Systems ein und drückt auf "Anmelden".
|Zu erwartendes Ergebnis a|
- Falls Benutzer bereits existiert.

Eine Fehlermeldung wird angezeigt, um den Benutzer über das Problem zu informieren.

- Falls Benutzer existiert nicht.

1. Ein neuer Kunde mit den angegebenen Daten wird erstellt
2. Es ist möglich, sich mit den Anmeldedaten des angelegten Kunden zu authentifizieren.
3. Der nicht authentifizierte Benutzer ist immer noch nicht authentifiziert und wird auf die Homepage umgeleitet.
|===
...
|Voraussetzungen       a|Ein Benutzer ist nicht angemeldet und besitzt einen Account.
|Event                 a|Benutzer klickt auf "Registrieren" , füllt das Formular aus und schickt es über "Registrierung abschließen" ab.
|Zu erwartendes Ergebnis a|
- Der Benutzer wird zu einem Willkommenseite weitergeleitet, der eine personalisierte Willkommensnachricht anzeigt.
- Der Benutzer hat nun Zugriff auf alle Funktionen, die für Benutzer mit der Rolle "Kunde" zugänglich sind.
...
|ID                     |**<<AT0021>>**
|Anwendungsfall         |**<<UC0020>>**
|Voraussetzungen       a|Ein authentifizierter Benutzer verwendet das System.
|Event                 a|Der authentifizierte Benutzer drückt auf "Ausloggen".
|Zu erwartendes Ergebnis a|
- Der Benutzer ist nun nicht authentifiziert.
- Der Benutzer wird zu einer Homepage weitergeleitet.
|===
...
|Voraussetzungen       a|None
|Event                 a|Ein authentifizierter Benutzer klickt auf den Knopf "Zahlenlotterien" oder "Fußballlotterien".
|Zu erwartendes Ergebnis a|
- Falls Knopf "Zahlenlotterien" geklickt wird.
    Alle Zahlenlotterien werden angezeigt.

- Falls Knopf "Fußballlotterien" geklickt wird.
    Alle Fußballlotterien werden angezeigt.
|===
...
|Voraussetzungen       a|Ein Benutzer hat sich angemeldet und ist in der Kontoverwaltung.
|Event                 a|Der Nutzer drückt in der Navigationsleiste der Kontoverwaltung den Button „betting“.
|Zu erwartendes Ergebnis a|
- Der Benutzer betritt die "betting"-Schnittstelle.
- Der Benutzer kann die Art des Lottoscheins auswählen, den er kaufen möchte.
|===
...
|ID                     |**<<AT0041>>**
|Anwendungsfall         |**<<UC0040>>**
|Voraussetzungen       a|Der Benutzer hat die „betting“-Schnittstelle aufgerufen.
|Event                 a|Der Benutzer klickt auf den Knopf "6-from-49".
|Zu erwartendes Ergebnis a|
- Der Benutzer kann 6 Ziffern aus 49 Ziffern auswählen.
- Der Benutzer kann eine zusätzliche Nummer hinzufügen.
- Der Nutzer kann die Art des „Dauertippscheins“ wählen.
- Der Benutzer kann den Betrag eingeben und eine Wette platzieren.
|===
...
|Anwendungsfall         |**<<UC0040>>**
|Voraussetzungen       a|Der Benutzer hat die „betting“-Schnittstelle aufgerufen.
|Event                 a|Der Benutzer klickt auf den Knopf "Fußballtoto".
|Zu erwartendes Ergebnis a|
- Der Benutzer kann die vorhergesagte Punktzahl des Spiels eingeben.
- Der Benutzer kann den Betrag eingeben und eine Wette platzieren.
|===
...
|Voraussetzungen       a|Der Benutzer ist authentifiziert.
|Event                 a|Ein authentifizierter Benutzer klickt auf den Knopf "Kontostand".
...
|Voraussetzungen       a|Der Benutzer ist authentifiziert.
|Event                 a|
_withdraw_: Ein authentifizierter Benutzer klickt auf den Knopf "withdraw".

_deposit_: Ein authentifizierter Benutzer klickt auf den Knopf "deposit".
|Zu erwartendes Ergebnis a|
- Ein authentifizierter Benutzer wird auf "withdraw.html"/"deposit.html" weitergeleitet.
- Ein authentifizierter Benutzer wählt den Betrag, den sie aufladen oder abheben möchten.
|===
...
|Event                 a|Der Nutzer drückt in der Navigationsleiste der Kontoverwaltung den Button „betting“.
|Zu erwartendes Ergebnis a|
Der Benutzer kann das ausgewertete Ergebnis der Lotterie einsehen.
|===
...
|Voraussetzung                |User hat sich beim System authentifiziert.
|Event                       a|
User klickt auf der Community Webseite auf den Knopf "create".
|Zu erwartendes Ergebnis     a|
-Ein Gemeinschaft wird gegründet.
-User erhält ein Gemeinschaftspasswort und kann mit diesem Passwort andere einladen, der Gemeinschaft beizutreten.
|===
...
|Voraussetzung                |User hat sich beim System authentifiziert.
|Event                       a|
1.User drückt auf der Community Website auf den Knopf "join".
2.User gebt das Passwort ein.
|Zu erwartendes Ergebnis     a|
-Falls das Passwort gültig ist, ist der Vereinigung beigetreten.
-Falls das Passwort ungültig ist, wird ein falsches Passwort angezeigt.
|===
...
|Voraussetzungen       a|Ein Benutzer hat sich angemeldet und ist in der Kontoverwaltung.
|Event                 a|Der Nutzer drückt in der Navigationsleiste der Kontoverwaltung den Button „message“.
|Zu erwartendes Ergebnis a|
Der Benutzer kann die empfangenen Nachrichten sehen.
|===
...
|===
|ID                     |**<<AT0130>>**
|Anwendungsfall         |**<<UC0130>>**
|Voraussetzungen       a|Benutzer hat Lottoschein gekauft
|Event                 a|Der Administrator drückt in der Navigationsleiste der Kontoverwaltung den Button „Überblick“.
|Zu erwartendes Ergebnis a|1. Kauft der Nutzer einen Fußball-Lotterieschein, werden die Quoten und der Wettbetrag im „Fußball“ angezeigt.
2. Kauft der Nutzer einen digitalen Lottoschein, wird die vom Nutzer gewählte Nummer und die Anzahl der gekauften Lottoscheine in „6 aus 49“ angezeigt.
|===
...
|===
|ID                     |**<<AT0140>>**
|Anwendungsfall         |**<<UC0140>>**
|Voraussetzungen       a|1. Benutzer hat Lotto gekauft
2. Die Lotterie wurde gezogen oder das Ergebnis des Spiels wurde veröffentlicht
|Event                 a|None
|Zu erwartendes Ergebnis a|1. Gewinnzahlen oder Fußballspielergebnisse anzeigen
2. Zeigen Sie die Wettsituation des Benutzers an
3. Bestimmen Sie, ob der Benutzer gewinnt oder verliert
|===
...
|===
|ID                     |**<<AT0150>>**
|Anwendungsfall         |**<<UC0150>>**
|Voraussetzungen       a|1. Benutzer hat Lotto gekauft
2. Die Lotterie wurde gezogen oder das Ergebnis des Spiels wurde veröffentlicht
|Event                 a|None
|Zu erwartendes Ergebnis a|Wenn das Guthaben des Benutzerkontos ausreichend ist:
1. Abzug
2. Benutzer zur Liste hinzufügen
Wenn das Guthaben des Benutzers nicht ausreicht:
Sende Nachrichten
|===
...
|===
|ID                     |**<<AT0160>>**
|Anwendungsfall         |**<<UC0160>>**
|Voraussetzungen       a|1. Benutzerkonto wurde erfolgreich belastet
2. Die Lotterie wurde gezogen oder das Ergebnis des Spiels wurde veröffentlicht
|Event                 a|None
|Zu erwartendes Ergebnis a|Wenn der Benutzer "gewinnt":
...
|Für die erfolgreiche Anmeldung wird ein Code an die E-Mail-Adresse oder Telefonnummer geschickt, welchen der Nutzer eingeben muss.
