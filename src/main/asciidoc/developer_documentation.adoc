...
=== Softwarearchitektur
image::./diagrams/developer_docu/top-level-archtiektur.svg[top-level-architecture, title= "Top-Level-Architektur", align=center]
...
|salespointframework.catalog |lottery.Betting
|salespointframework.core a|
- lottery.UserDataInitializer
- lottery.BetDataInitializer
|salespointframework.payment |lottery.Finance
|salespointframework.SalespointSecurityConfiguration |lottery.WebSecurityConfiguration
|salespointframework.userAccount |lottery.User
|springframework.boot |lottery.Application
|springframework.data a|
- lottery.BetRepository
- lottery.CommunityRepository
- lottery.FinanceRepository
- lottery.FootballBetCatalog
- lottery.NumberLotteryRepository
- lottery.UserRepository
|springframework.security |lottery.WebSecurityConfiguration
|springframework.ui a|
- lottery.BetController
- lottery.CommunityController
- lottery.FinanceController
- lottery.UserController
