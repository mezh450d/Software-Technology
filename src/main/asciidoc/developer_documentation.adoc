...
=== Benutzeroberfläche
image::./diagrams/user_interface.svg[user-interface, title= "Benutzeroberfläche", align=center]
...
== Bausteinsicht
=== User
image::./diagrams/class_user.svg[user, title= "User", align=center]
...
=== Community
image::./diagrams/class_community.svg[community, title= "Community", align=center]
...
=== Betting
image::./diagrams/class_betting.svg[betting, title= "Betting", align=center]
